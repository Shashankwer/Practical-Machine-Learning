...
## 
##   cp         Accuracy   Kappa    
##   0.2437102  0.7278546  0.6539690
##   0.2569069  0.5659613  0.4454041
##   0.2703883  0.3384283  0.0926674
## 
...
![](PML_files/figure-html/unnamed-chunk-8-1.png)<!-- -->
...
## Specificity            1.0000   1.0000   1.0000   1.0000   0.5855
...
## Detection Prevalence   0.2843   0.1935   0.0000   0.0000   0.5221
## Balanced Accuracy      1.0000   1.0000   0.5000   0.5000   0.7927
```
...
## No pre-processing
## Resampling: Cross-Validated (10 fold, repeated 10 times) 
## Summary of sample sizes: 13245, 13245, 13247, 13246, 13247, 13245, ... 
## Resampling results across tuning parameters:
## 
##   mtry  Accuracy   Kappa    
##    2    0.9986548  0.9982985
##   25    0.9999796  0.9999742
##   48    0.9999796  0.9999742
## 
## Accuracy was used to select the optimal model using  the largest value.
...
![](PML_files/figure-html/unnamed-chunk-10-2.png)<!-- -->
...
## Balanced Accuracy      0.9999   0.9995   1.0000   1.0000   1.0000
```
